  ...
  <body>
    ...
    <header class="header">
      ...
      <nav class="nav">
        ...
        <a href="#about" class="navbar"  onclick="openSection('about')"><i class='bx bxs-user'></i>About Us</a>
      </nav>
    </header>
    <!-- header end -->
    <!-- home section start -->
    ...
    <!-- home section end -->
    <!-- about section start -->
    <section class="displaysections about" id="about">
      <div class="container">
        <div class="title">
          <h2>About MinT</h2>
          <p>
            Ministry of Innovation and Technology (MinT) of Ethiopia is dedicated to fostering innovation, 
            science, and technology to accelerate the nation's development and modernization.
          </p>
        </div>
        <div class="padd-30">
          <p>This Record Management System (RMS) is a vital tool for ensuring efficient communication and secure 
          handling of records between the public and our various departments including IT, Computer, and Research.</p>
        </div>
      </div>
    </section>
    <!-- about section end -->
      ...
      <div class="container">
          ...
          <div class="tab-contents" id="exprience">
            <div class="typeLetter">
                  <form action="#" method="POST"> <!-- action changed from indexLetterSubmit.php for demo -->
                    <div class="form-container">
                      ...
                      <div class="email">
                        <label for="emailLetter">Email Address:</label>
                        <input type="email" id="emailLetter" name="emailAddress" placeholder="ex..me@gmail.com" required>
                      </div>
                      <div class="Unic">
                        <label for="uniquecodeLetter">MinT Unique Code:</label>
                        <input type="password" id="uniquecodeLetter" name="uniquecode" placeholder="MinT Unique Code" required>
                      </div>
                      <div class="mobile">
                        <label for="mobileNumLetter">Phone Number:</label>
                        <input type="number" id="mobileNumLetter" name="mobileNum" placeholder="ex..0912456545" required>
                      </div>
                      <div class="letter">
                          <label for="letter">Write Letter : </label>
                          <textarea name="letter" id="letter" cols="30" rows="10" required placeholder="Write your letter here..."></textarea>
                      </div>
                      <div class="description">
                          <label for="description">Summary/Description : </label>
                          <input type="text" name="description" id="description" required placeholder="A short description of your letter">
                      </div>
                      <div class="buttons">
                          <button type="submit" name="submitLetter">Submit</button>
