                  ...
                  <table>
                    ...
                    <?php foreach ($rows as $row) : ?>
                      <tr class="lists" data-row-id="<?php echo $row['id']; ?>">
                        ...
                        <td>
                          <?php if (strpos($row["image"], 'LETTER_RECORD_') === 0): ?>
                             <div class="letter-icon" title="Typed Letter">
                               <i class='bx bxs-envelope' style='font-size: 40px;'></i>
                               <p>Letter</p>
                             </div>
                          <?php else: ?>
      ...
      <section class="sections setting " id="setting">
                <div class="savechanges stored">
                  ...
                  <span>
                    <?php
                      ...
                      $result4 = mysqli_query($conn, "SELECT COUNT(*) as count FROM ministeradmin");
                      $rowCount4 = mysqli_fetch_assoc($result4)['count'];

                      mysqli_close($conn);

                      echo $rowCount+$rowCount2+$rowCount3+$rowCount4;
                      ?>
                    </span>
                </div>
                <div class="tableBox" id="declinedMessagesTable" style="display: none;">
                    ...
                    <div class="manageTable">
                      <table class="admintableBox managelists">
                        ...
                        <?php
                          include '../connection.php';
                          $i = 1;
                          $tables = ["admintable", "computeradmintable", "itadmintable", "ministeradmin"];
                  ...
                  <form action="./adminsignup.php" name="systemsignForm" method="POST" onsubmit="return systemvalidateForms(event)">
                      ...
                      <div class="position">
                          ...
                          <select id="position" name="position" required>
                              <option value="" disabled selected><h4>Select a Department</h4></option>
                              ...
                              <option value="Minister"><h4>Minister</h4></option>
                          </select>
                      </div>
                      <div class="setButton">
              ...
              <div class="contact_table" id="acceptedMessagesTable" style="display: none;">
                <table class="admintableBox">
                  ...
                  <?php
                    require '../connection.php';
                    $contactRows = mysqli_query($conn, "SELECT * FROM contactUser ORDER BY id DESC");
                    $cj = 1;
                    while($crow = mysqli_fetch_assoc($contactRows)) :
                  ?>
                  <tr>
                    <td><?php echo $cj++; ?></td>
                    <td><?php echo htmlspecialchars($crow["Fullname"], ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><?php echo htmlspecialchars($crow["email"], ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><?php echo htmlspecialchars($crow["phonenumber"], ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><?php echo htmlspecialchars($crow["description"], ENT_QUOTES, 'UTF-8'); ?></td>
                  </tr>
                  <?php endwhile; ?>
                </table>
              </div>
